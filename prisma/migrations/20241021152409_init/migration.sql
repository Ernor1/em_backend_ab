...
CREATE TABLE "Attendance" (
    "id" TEXT NOT NULL,
    "attendanceSettingId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Attendance" ADD CONSTRAINT "Attendance_attendanceSettingId_fkey" FOREIGN KEY ("attendanceSettingId") REFERENCES "AttendanceSetting"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
